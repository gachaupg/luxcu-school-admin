          ...
          <main className="flex-1 px-8 py-6 bg-gray-100">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <ul className="text-gray-600 space-y-1 list-disc list-inside mb-2">
                <li>View parent contact info and associated students.</li>
                <li>Send trip updates or notifications.</li>
                <li>Review parent feedback and communications.</li>
              </ul>
              <img
                src="https://images.unsplash.com/photo-1503676382389-4809596d5290?w=500&q=80"
                alt="Parents"
