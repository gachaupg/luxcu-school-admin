...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <section id="contact" className={`py-16 bg-slate-900 section-animate ${animatedSections.has("contact") ? "animate" : ""}`}>
      ...
      <section id="testimonials" className={`py-16 bg-slate-900 section-animate ${animatedSections.has("testimonials") ? "animate" : ""}`}>
      ...
      {/* FAQ Section */}
      <section id="faq" className={`py-16 bg-slate-900 section-animate ${animatedSections.has("faq") ? "animate" : ""}`}>
